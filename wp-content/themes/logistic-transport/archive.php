        ...
        if($logistic_transport_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    ?>
                    <?php if( get_theme_mod( 'logistic_transport_navigation_hide',true) != '') { ?>
                        <?php if( get_theme_mod( 'logistic_transport_post_navigation_position','bottom') == 'top' || get_theme_mod( 'logistic_transport_post_navigation_position','bottom') == 'both')  { ?>
                            <div class="navigation my-3">
                                <?php logistic_transport_post_navigation();?>
                    ...
                    ?>
                    <?php if( get_theme_mod( 'logistic_transport_navigation_hide',true) != '') { ?>
                        <?php if( get_theme_mod( 'logistic_transport_post_navigation_position','bottom') == 'bottom' || get_theme_mod( 'logistic_transport_post_navigation_position','bottom') == 'both')  { ?>
                            <div class="navigation my-3">
                                <?php logistic_transport_post_navigation();?>
                                <div class="clearfix"></div>
                            </div>
